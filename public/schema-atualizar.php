...
define('SECRET_KEY', 'encartes2024_atualizar');
...
try {
    ...
    $resposta = [
        'sucesso' => empty($erros),
        'mensagem' => empty($erros) ? 'Schema atualizado com sucesso!' : 'Schema atualizado com alguns erros',
        'tabelas_criadas' => count($tabelas),
        'tabelas_no_banco' => count($tabelasExistentes),
        'tabelas' => $resultados,
        'erros' => $erros,
        'data_executado' => date('Y-m-d H:i:s')
    ];
