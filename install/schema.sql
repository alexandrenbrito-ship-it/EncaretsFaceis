-- ================================================
-- BANCO DE DADOS - ENCARTES PRO
-- ================================================

CREATE TABLE IF NOT EXISTS enc_usuarios (
...
CREATE TABLE IF NOT EXISTS enc_planos (
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS enc_lojistas (
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS enc_templates_encarte (
    id INT PRIMARY KEY AUTO_INCREMENT,
    nome VARCHAR(100) NOT NULL,
    descricao TEXT,
...
CREATE TABLE IF NOT EXISTS enc_encartes (
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS enc_clientes_pwa (
    id INT PRIMARY KEY AUTO_INCREMENT,
    lojista_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS enc_localizacoes_clientes (
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS enc_visualizacoes_encarte (
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS enc_visualizacoes_vitrine (
    id INT PRIMARY KEY AUTO_INCREMENT,
    lojista_id INT NOT NULL,
    ip_hash VARCHAR(64) NULL,
    cidade VARCHAR(100) NULL,
...
CREATE TABLE IF NOT EXISTS enc_notificacoes_push (
    id INT PRIMARY KEY AUTO_INCREMENT,
    lojista_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS enc_pagamentos (
    id INT PRIMARY KEY AUTO_INCREMENT,
    lojista_id INT NOT NULL,
    plano_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS enc_configuracoes (
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS enc_logs_atividade (
    id INT PRIMARY KEY AUTO_INCREMENT,
    usuario_id INT NULL,
    lojista_id INT NULL,
