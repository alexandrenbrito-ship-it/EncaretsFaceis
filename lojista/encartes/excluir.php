...
$resultado = $encarteModel->delete($encarteId);

if ($resultado) {
    echo json_encode(['sucesso' => true, 'mensagem' => 'Encarte excluído com sucesso!']);
} else {
    echo json_encode(['sucesso' => false, 'erro' => 'Erro ao excluir encarte']);
}